...
public class OgnlValueStackTest extends XWorkTestCase {
     ...
     * when no static access flags are set.
     */
    public void testOgnlValueStackFromOgnlValueStackFactory() {
        ...
        try {
            ...
            fail("Unable to reload container configuration and set valuestackfactory - exception: " + ex);
        }
        ...
        // should prevent staticMethodAccess, but permit staticFieldAccess.
        ...
        assertTrue("OgnlValueStackFactory staticFieldAccess (no flag present) not true?", ognlValueStackFactory.containerAllowsStaticFieldAccess());
        // An OgnlValueStack created from the above OgnlValueStackFactory should allow public field access,
        // but prevent non-public field access.  It should also deny static field access.
        accessedValue = ognlValueStack.findValue("@com.opensymphony.xwork2.util.OgnlValueStackTest@staticInteger100Method()");
    ...
    private void reloadTestContainerConfigurationNoStaticAccessFlagsSet() throws Exception {
        ...
        // allowStaticFieldAccess, allowStaticMethodAccess both undefined.
        // The default values should be true for allowStaticFieldAccess, false for allowStaticMethodAccess
        ConfigurationProvider configurationProvider = new XmlConfigurationProvider("com/opensymphony/xwork2/config/providers/xwork-test-allowstatic-notset.xml", true);
