 ...
 * &lt;-- in freemarker form --&gt;
 * [ww.bean name="org.apache.struts.webwork.example.counter.SimpleCounter" id="counter"]
 *   [a:param name="foo" value="BAR"/]
 *   The value of foo is : [a:property value="foo"/], when inside the bean tag.<br />
 * [/a:bean]
 *
 * &lt;-- in jsp form --&gt;
 * &lt;a:bean name="org.apache.struts.webwork.example.counter.SimpleCounter" id="counter"&gt;
 * 	 &lt;a:param name="foo" value="BAR" /&gt;
 ...
 * @see Param
 *
 * @a2.tag name="bean" tld-body-content="JSP" tld-tag-class="org.apache.struts.webwork.views.jsp.BeanTag"
