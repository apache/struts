 ...
 * @since 2.2
 *
 * @see org.apache.struts.webwork.interceptor.TokenInterceptor
 * @see org.apache.struts.webwork.interceptor.TokenSessionStoreInterceptor
 *
 * @a2.tag name="token" tld-body-content="JSP" tld-tag-class="org.apache.struts.webwork.views.jsp.ui.TokenTag"
...
public class Token extends UIBean {
    ...
    /**
     * First looks for the token in the PageContext using the supplied name (or {@link org.apache.struts.webwork.util.TokenHelper#DEFAULT_TOKEN_NAME}
