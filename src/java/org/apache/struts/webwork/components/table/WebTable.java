...
/**
 * @a2.tag name="table" tld-body-content="JSP" tld-tag-class="org.apache.struts.webwork.views.jsp.ui.table.WebTableTag"
...
public class WebTable extends GenericUIBean {
    ...
    /**
     * Whether the table should be sortable. Requires that model implements org.apache.struts.webwork.components.table.SortableTableModel if set to true.
