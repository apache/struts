...
import org.apache.struts.webwork.dispatcher.multipart.MultiPartRequest;
...
public class DispatcherUtils {
    ...
    protected void init(ServletContext servletContext) {
        ...
        if (Configuration.isSet(StrutsConstants.STRUTS_OBJECTFACTORY)) {
            ...
            if (className.equals("spring")) {
                ...
                className = "org.apache.struts.webwork.spring.StrutsSpringObjectFactory";
            } else if (className.equals("plexus")) {
                // note: this class name needs to be in string form so we don't put hard
                //       dependencies on spring, since it isn't technically required.
                className = "org.apache.struts.webwork.plexus.PlexusObjectFactory";
            }
     ...
     * requests in a special way or to handle other types of requests. Note, {@link org.apache.struts.webwork.dispatcher.multipart.MultiPartRequestWrapper} is
     * flexible - you should look to that first before overriding this method to handle multipart data.
     *
     * @param request the HttpServletRequest object.
     * @return a wrapped request or original request.
     * @see org.apache.struts.webwork.dispatcher.multipart.MultiPartRequestWrapper
     */
