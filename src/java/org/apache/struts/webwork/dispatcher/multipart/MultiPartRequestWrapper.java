 ...
 * All rights reserved.
 */
package org.apache.struts.webwork.dispatcher.multipart;

import org.apache.struts.webwork.config.Configuration;
import org.apache.struts.webwork.dispatcher.StrutsRequestWrapper;
 ...
 * extends {@link org.apache.struts.webwork.dispatcher.multipart.MultiPartRequest}. <p>
 * <p/>
 * Webwork ships with three implementations,
 * {@link org.apache.struts.webwork.dispatcher.multipart.PellMultiPartRequest}, and
 * {@link org.apache.struts.webwork.dispatcher.multipart.CosMultiPartRequest} and
 * {@link org.apache.struts.webwork.dispatcher.multipart.JakartaMultiPartRequest}. The Jakarta implementation
        ...
        if (request instanceof MultiPartRequest) {
            ...
            if (parser.equals("")) {
                log.warn("Property struts.multipart.parser not set." +
                        " Using org.apache.struts.webwork.dispatcher.multipart.JakartaMultiPartRequest");
                parser = "org.apache.struts.webwork.dispatcher.multipart.JakartaMultiPartRequest";
            }
            // legacy support for old style property values
            else if (parser.equals("pell")) {
                parser = "org.apache.struts.webwork.dispatcher.multipart.PellMultiPartRequest";
            } else if (parser.equals("cos")) {
                parser = "org.apache.struts.webwork.dispatcher.multipart.CosMultiPartRequest";
            } else if (parser.equals("jakarta")) {
                parser = "org.apache.struts.webwork.dispatcher.multipart.JakartaMultiPartRequest";
            }

            try {
                Class baseClazz = org.apache.struts.webwork.dispatcher.multipart.MultiPartRequest.class;
