        ...
        synchronized (session) {
            ...
            if (!bp.isDone()) {
                ...
                if (!results.containsKey(WAIT)) {
                    ...
                    ResultConfig rc = new ResultConfig(WAIT, "org.apache.struts.webwork.views.freemarker.FreemarkerResult",
                            Collections.singletonMap("location", "org/apache/struts/webwork/interceptor/wait.ftl"));
                    results.put(WAIT, rc);
                }
