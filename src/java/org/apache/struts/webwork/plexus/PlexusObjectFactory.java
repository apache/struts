package org.apache.struts.webwork.plexus;
    ...
    public void init(ServletContext servletContext) {
        if (!PlexusLifecycleListener.loaded || !PlexusFilter.loaded) {
            ...
            String message = "********** FATAL ERROR STARTING UP PLEXUS-STRUTS INTEGRATION **********\n" +
                    ...
                    "        <filter-class>org.apache.struts.webwork.plexus.PlexusFilter</filter-class>\n" +
                    "    </filter>\n" +
                    "\n" +
                    "...\n" +
                    "\n" +
                    ...
                    "\n" +
                    "    <listener>\n" +
                    "        <listener-class>org.apache.struts.webwork.plexus.PlexusLifecycleListener</listener-class>\n" +
                    "    </listener>";
            log.fatal(message);
            return;
        }
