    ...
    public void onStop(final File pRepository) {
        ...
        if (deleted.size() > 0) {
            for (Iterator it = deleted.iterator(); it.hasNext();) {
                ...
                store.remove(org.apache.struts.webwork.util.classloader.ReloadingClassLoader.clazzName(pRepository, file));
            }
            reload = true;
        }
        ...
        if (created.size() > 0) {
            for (Iterator it = created.iterator(); it.hasNext();) {
                ...
                try {
                    ...
                    store.write(org.apache.struts.webwork.util.classloader.ReloadingClassLoader.clazzName(pRepository, file), bytes);
