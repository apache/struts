...
import org.apache.struts2.xwork2.interceptor.LoggingInterceptor;
...
public class XmlConfigurationProviderInterceptorsTest extends ConfigurationTestBase {
    ...
    public void testBasicInterceptors() throws ConfigurationException {
        final String filename = "org/apache/struts2/xwork2/config/providers/xwork-test-interceptors-basic.xml";
    ...
    public void testInterceptorDefaultRefs() throws ConfigurationException {
        loadConfigurationProviders(new XmlConfigurationProvider("org/apache/struts2/xwork2/config/providers/xwork-test-interceptor-defaultref.xml"));
    ...
    public void testInterceptorInheritance() throws ConfigurationException {
        ...
        ConfigurationProvider provider = buildConfigurationProvider("org/apache/struts2/xwork2/config/providers/xwork-test-interceptor-inheritance.xml");
    ...
    public void testInterceptorParamOverriding() throws Exception {
        ...
        ConfigurationProvider provider = buildConfigurationProvider("org/apache/struts2/xwork2/config/providers/xwork-test-interceptor-params.xml");
