...
public class XmlConfigurationProviderPackagesTest extends ConfigurationTestBase {
    ...
    public void testBadInheritance() throws ConfigurationException {
        final String filename = "org/apache/struts2/xwork2/config/providers/xwork-test-bad-inheritance.xml";
    ...
    public void testBasicPackages() throws ConfigurationException {
        final String filename = "org/apache/struts2/xwork2/config/providers/xwork-test-basic-packages.xml";
        ConfigurationProvider provider = buildConfigurationProvider(filename);
        provider.init(configuration);
        provider.loadPackages();
    ...
    public void testDefaultPackage() throws ConfigurationException {
        final String filename = "org/apache/struts2/xwork2/config/providers/xwork-test-default-package.xml";
        ConfigurationProvider provider = buildConfigurationProvider(filename);
        provider.init(configuration);
        provider.loadPackages();
    ...
    public void testPackageInheritance() throws ConfigurationException {
        final String filename = "org/apache/struts2/xwork2/config/providers/xwork-test-package-inheritance.xml";
        ConfigurationProvider provider = buildConfigurationProvider(filename);
    ...
    public void testDefaultClassRef() throws ConfigurationException {
    	final String filename = "org/apache/struts2/xwork2/config/providers/xwork-test-defaultclassref-package.xml";
        final String hasDefaultClassRefPkgName = "hasDefaultClassRef";
        final String noDefaultClassRefPkgName = "noDefaultClassRef";
        final String testDefaultClassRef = "org.apache.struts2.xwork2.ActionSupport";
