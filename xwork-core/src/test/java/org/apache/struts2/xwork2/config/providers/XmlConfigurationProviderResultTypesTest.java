 ...
 * 
 * @author tm_jee
 * @version $Date: 2011-12-02 12:24:48 +0100 (Fri, 02 Dec 2011) $ $Id: XmlConfigurationProviderResultTypesTest.java 1209415 2011-12-02 11:24:48Z lukaszlenart $
 */
public class XmlConfigurationProviderResultTypesTest extends ConfigurationTestBase {
	...
	public void testPlainResultTypesParams() throws Exception {
		ConfigurationProvider configurationProvider = buildConfigurationProvider("org/apache/struts2/xwork2/config/providers/xwork-test-result-types.xml");
	...
	public void testInheritedResultTypesParams() throws Exception {
		...
		assertEquals(action1Result.getClassName(), "org.apache.struts2.xwork2.mock.MockResult");
		assertEquals(action1Result.getName(), "success");
		assertEquals(action1Result.getClassName(), "org.apache.struts2.xwork2.mock.MockResult");
