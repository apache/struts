...
public class XmlConfigurationProviderTest extends ConfigurationTestBase {
    ...
    public void testLoadOrder() throws Exception {
        ...
        XmlConfigurationProvider prov = new XmlConfigurationProvider("xwork-test-load-order.xml", true) {
            ...
            protected Iterator<URL> getConfigurationUrls(String fileName) throws IOException {
                ...
                urls.add(ClassLoaderUtil.getResource("org/apache/struts2/xwork2/config/providers/loadorder1/xwork-test-load-order.xml", XmlConfigurationProvider.class));
                urls.add(ClassLoaderUtil.getResource("org/apache/struts2/xwork2/config/providers/loadorder2/xwork-test-load-order.xml", XmlConfigurationProvider.class));
                urls.add(ClassLoaderUtil.getResource("org/apache/struts2/xwork2/config/providers/loadorder3/xwork-test-load-order.xml", XmlConfigurationProvider.class));
    ...
    public void testInheritence() throws Exception {
        final String filename = "org/apache/struts2/xwork2/config/providers/xwork-include-parent.xml";
        ConfigurationProvider provider = buildConfigurationProvider(filename);
    ...
    public void testEmptySpaces() throws Exception {
        final String filename = "org/apache/struts2/xwork2/config/providers/xwork- test.xml";
        FileManager.setReloadingConfigs(true);
