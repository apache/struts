 ...
 * @version $Id: ConversionTestAction.java 1209415 2011-12-02 11:24:48Z lukaszlenart $
 */
@Conversion()
public class ConversionTestAction implements Action {
     ...
     */
    @TypeConversion(type = ConversionType.APPLICATION, key = "java.util.Date", converter = "org.apache.struts2.xwork2.util.XWorkBasicConverter")
